...
var YOUSUCAI = {
	...
	other: function(){
		...
		if(_MBT.anchor == '1' && that.body.hasClass("home") && jQuery(".contents .mocat").length){
    		var home_anchor_html = '<<ul class="home-anchors"><li><a href="javascript:scrollTo();"><i class="icon icon-home-s"></i></a></li>';
		...
		jQuery(".yousucaiw-scroll-h").each(function() {
			var t = jQuery(this),
			n = t.children("ul");
			if (! (n.length < 2)) {
				var e = 0,
		...
		jQuery(".search-form .search-cat")
			jQuery(this).parent().find(".search-cats").toggleClass("show");
		

		jQuery(".search-form .search-cats li")
...
// //                            console.log(e.clientX,that.pgBarClientLeft,that.toParLeft);
	...
	login: function(){
		...
		jQuery(function($){
			...
			$("body").on("click", ".yousucaiw-login-must", function(){
