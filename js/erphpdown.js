    		...
    		$.post(_ERPHP.ajaxurl, {
	            ...
	            if(data.status == '1'){
	            	...
	            	if(that.hasClass('erphp-promo-do-vip')){
	            		var oldprice = $(".erphpdown-type-desc .type-price span").text();
	            		if(data.type == 1){
	            			$(".erphpdown-type-desc .type-price span").html((oldprice-data.money).toFixed(2)+' <del>'+oldprice+'</del>');
	            		}else if(data.type == 2){
	            			$(".erphpdown-type-desc .type-price span").html((oldprice*0.1*data.money).toFixed(2)+' <del>'+oldprice+'</del>');
	            		}
	            		...
	            		var oldprice = $(".item-price .tit t").data("price");
	            		var jmoney = data.money;
	            		if(nologin == '1'){
	            			jmoney = data.money / $(".item-price .tit t").data("proportion");
	            		}
	            		if(data.type == 1){
	            			$(".item-price .tit t").html((oldprice-jmoney).toFixed(2)+' <del>'+oldprice+'</del>');
	            		}else if(data.type == 2){
	            			$(".item-price .tit t").html((oldprice*0.1*data.money).toFixed(2)+' <del>'+oldprice+'</del>');
	            		}
	            	}
	            }else{
	            	layer.msg("优惠码无效");
